...
pathogenic_variants_file_location = os.path.join(source_dir_of_required_files, "mutpred_mtoolbox_apogee_cheat_sheet.csv")
...
source_dir_of_mtdnaserver_variant_files = sg.popup_get_folder(message ='Please select the folder in which you have saved '
...
#define layout
layout=[
        [sg.Text('Which mitochondrial haplogroups would you like to include in the analysis?',size=(65, 2), font=('Arial', 12),justification='left')],
        [sg.Listbox(values=['African', 'European'], font=('Arial', 12), select_mode='extended', key='ancestry', size=(30, 2))],
...
dir_of_analysis_files = sg.popup_get_folder(message='Please select the folder in which to save your analysis output files',
                                           title='Select a folder')
# change the directory to the one selected by the user
