...
het_levels = pd.concat([heteroplasmic_merge, homoplasmic_merge], axis=0, sort = False)
het_levels = het_levels[['haplo_merge_ref', 'heteroplasmy_%']]
...
easygui.msgbox("SUCCESS!! \n\n"
               "Your file (mitomaster_upload_file.txt) is complete and has been saved to the folder you have "
               "selected!\n\n"
               ...
               "3. Under Step 2, Option 2: upload your 'mitomaster_upload_file.txt' file by clicking on the "
               ...
               "6. Save the CSV file with a file name that:\n\n"
